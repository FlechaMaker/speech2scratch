...
LF=$(printf '\\\012_')
LF=${LF%_}
EXTENSION_NAME=Speech2Scratch
EXTENSION_ID=speech2scratch
...
cp ${EXTENSION_DIR}/scratch-gui/src/lib/libraries/extensions/${EXTENSION_ID}/${EXTENSION_ID}-small.png node_modules/scratch-gui/src/lib/libraries/extensions/${EXTENSION_ID}/
...
sed -e "s|^export default \[$|import ${EXTENSION_ID}IconURL from './${EXTENSION_ID}/${EXTENSION_ID}.png';${LF}import ${EXTENSION_ID}InsetIconURL from './${EXTENSION_ID}/${EXTENSION_ID}-small.png';${LF}${LF}export default [${LF}${DESCRIPTION}|g" node_modules/scratch-gui/src/lib/libraries/extensions/index.jsx_orig > node_modules/scratch-gui/src/lib/libraries/extensions/index.jsx
